<?php
    ...
    {
        $query  = "SELECT password FROM id_password_table WHERE user_id = '$postuserid'";
        ...
        while ($row = mysqli_fetch_array($result))
        {
            ...
            if($pass == $postpass)
            {
                echo "CORRECT, postuserid=". $postuserid . PHP_EOL;
                return;
            }
        }
        echo "CAN'T MATCH DEVICE ID AND PASSWORD" . PHP_EOL;
    }
    mysqli_close($link);
?>